...
const TimelineTreasureHunt: React.FC<TimelineTreasureHuntProps> = ({ language, onBack }) => {
  ...
  const questions: GameQuestion[] = [
    ...
    {
      id: '6',
      question: 'This surgical technique for reconstructing facial features was pioneered in ancient India.',
      clues: [
        'Developed by the ancient surgeon Sushruta',
        'Particularly used for nose reconstruction',
        'Described in detail in ancient medical texts',
        'Still forms the basis of modern reconstructive surgery'
      ],
      ...
      invention: {
        ...
        significance: 'Foundation of modern plastic and reconstructive surgery'
      },
      difficulty: 'hard',
      points: 30
    },
    {
      id: '7',
      question: 'This mathematical sequence where each number is the sum of the two preceding ones was first described in India.',
      clues: [
        'Named after an Italian mathematician but discovered in India first',
        'Appears frequently in nature and art',
        'Used to analyze Sanskrit poetry meters',
        'Described by Virahanka and Hemachandra'
      ],
      answer: 'Fibonacci Numbers',
      invention: {
        id: '7',
        name: 'Fibonacci Numbers',
        description: 'Mathematical sequence fundamental to nature and mathematics',
        inventor: 'Virahanka and Hemachandra',
        year: 1150,
        location: 'Karnataka',
        category: 'Mathematics',
        significance: 'Fundamental mathematical concept appearing throughout nature'
      },
      difficulty: 'hard',
      points: 30
    },
    {
      id: '8',
      question: 'This ancient sanitation system was the world\'s first urban waste management solution.',
      clues: [
        'Featured in the Indus Valley Civilization',
        'Every house had access to this system',
        'Used water to remove waste efficiently',
        'Included sophisticated drainage networks'
      ],
      answer: 'Flush Toilet',
      invention: {
        id: '8',
        ...
        significance: 'World\'s first urban sanitation system'
      },
      difficulty: 'medium',
      points: 20
    },
    {
      id: '9',
      question: 'This hair care treatment gave its name to a global industry worth billions today.',
      clues: [
        'The word comes from Hindi "champo" meaning to massage',
        'Originally used natural herbs and oils',
        'Developed by ancient Indian healers',
        'Revolutionized hair care and hygiene practices'
      ],
      answer: 'Shampoo',
      invention: {
        id: '9',
        ...
        significance: 'Foundation of the global hair care industry'
      },
      difficulty: 'easy',
      points: 10
    },
    {
      id: '10',
      question: 'These iron-cased military projectiles influenced modern rocket technology.',
      clues: [
        'Developed by Tipu Sultan\'s engineers',
        'Could travel over a mile in distance',
        'Featured explosive warheads',
        'Influenced European rocket development'
      ],
      answer: 'Mysorean Rockets',
      invention: {
        id: '10',
    ...
    {
      id: '11',
      question: 'This standardized measurement tool enabled precise construction in ancient times.',
      clues: [
        'Created by the Indus Valley Civilization',
        'Featured decimal subdivisions',
        'Enabled uniform city construction',
        'Foundation of all modern measurement systems'
      ],
      answer: 'Ruler',
      invention: {
        id: '11',
    ...
    {
      id: '12',
      question: 'This architectural marvel combined water storage with artistic beauty.',
      clues: [
        'Featured intricate carvings and geometric designs',
        'Provided water access during dry seasons',
        'Created cool microclimates',
        'Found primarily in western India'
      ],
      answer: 'Stepwell',
      invention: {
        id: '12',
        ...
        significance: 'Ingenious water management combining function with beauty'
      },
      difficulty: 'medium',
      points: 20
    }
