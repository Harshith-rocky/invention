...
import { Lightbulb, Globe, Compass, Gamepad2, MessageCircle, Home, Wrench, BookOpen, Palette, Trophy, User } from 'lucide-react';
          ...
          <div className="flex items-center space-x-4">
            ...
            {currentUser && (
              <motion.button
                ...
                className="flex items-center space-x-2 px-3 py-2 bg-gradient-to-r from-blue-100 to-purple-100 rounded-xl hover:from-blue-200 hover:to-purple-200 transition-all"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                ...
                <span className="font-medium text-gray-700 hidden md:block">{currentUser.username}</span>
              </motion.button>
            )}
