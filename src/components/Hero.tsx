...
import { ArrowRight, Sparkles, Compass, Wrench, MessageCircle, BookOpen, Trophy, Palette, Zap, Users } from 'lucide-react';
...
const Hero: React.FC<HeroProps> = ({ onNavigate }) => {
  const features = [
    ...
    },
    {
      icon: Users,
      title: 'Leaderboard',
      description: 'See how you rank against other explorers',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Seven unique ways to discover India's innovation legacy through interactive experiences
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 text-center text-white">
            {[
              ...
              { number: '7', label: 'Interactive Games', icon: Trophy },
